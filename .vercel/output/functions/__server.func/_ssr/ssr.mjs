...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Ln4nGo4I.mjs");
...
var manifest = {
	"063d3025aad1bd80fb868a0213c71a02b04f554784fa5b12306c135589d02638": {
		functionName: "listScores_createServerFn_handler",
		importer: () => import("./leaderboard-BIy5Cq7p.mjs")
	},
	"5fb255a53919c2953dd858210577789b5388e0377e6c62638dec1eff1d18eabc": {
		functionName: "submitScore_createServerFn_handler",
		importer: () => import("./leaderboard-BIy5Cq7p.mjs")
	},
	"f74adc58b24261945d48bdd13fa3dc6840428ec315ad2c5b594051a137a44fc5": {
		functionName: "recordPlay_createServerFn_handler",
		importer: () => import("./leaderboard-BIy5Cq7p.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CittSRdW.mjs").then((n) => n.t),
